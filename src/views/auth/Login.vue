    ...
    <div class="loginPrincipal">
        <div class="main">
            ...
            <div class="signup">
                ...
                <input type="text" class="inputLogin" name="txt" placeholder="User name" required="" v-model="registro.nombre" :class="{'error' : errors.nombre}">
...
import { ref } from 'vue'
import { cerrarSesion, iniciarSesion, registroUsuario, registroCliente } from '@/services/authService.js'
import { useRouter } from 'vue-router'
    ...
    const registrar = async () => {
        errors.value = {};
        try {
            const { data } = await registroCliente(registro.value);
            Swal.fire({
                text: data.mensaje,
                title: 'Bien!',
                icon: 'success'
